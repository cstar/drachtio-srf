...
class Dialog extends Emitter {
  ...
  constructor(srf, type, opts) {
    ...
    // Bind SIP method shortcuts to this instance so they work when
    // destructured: const {ack} = dialog; ack(sdp);
    // This is needed because srf.js destructures dialog methods for 3PCC.
    methods.forEach((method) => {
      this[method.toLowerCase()] = (opts, cb) => {
        opts = opts || {};
        opts.method = method;
